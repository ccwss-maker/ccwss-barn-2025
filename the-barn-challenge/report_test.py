    ...
    with open(args.out_path, "r") as f:
        for l in f.readlines():
            ...
            nav_log = NavLog(
                ...
                bool(int(logs[3])),
                float(logs[4]),
                int(logs[1]) * optimal_times[world_idx] / np.clip(float(logs[4]), optimal_times[world_idx] * 2, optimal_times[world_idx] * 4)  # 1_success * optimal_time / clip(actual_time, 2 * optimal_time, 4 * optimal_time)
            )
